import { isTruthy, equals, compare } from './values';
export class Evaluator {
    ...
    evalMember(expr) {
        ...
        if (typeof obj === 'object' && obj !== null) {
            ...
            if (Array.isArray(obj) && typeof expr.property === 'number')
                return obj[expr.property];
        }
        return null;
    }
            ...
            case 'IfStatement':
                if (isTruthy(this.evalExpression(stmt.condition))) {
                    for (const s of stmt.thenBranch) {
                        ...
                        if (r !== null && (s.type === 'ReturnStatement' || s.type === 'BreakStatement' || s.type === 'ContinueStatement'))
                            return r;
                    }
                }
                ...
                while (isTruthy(this.evalExpression(stmt.condition))) {
                    for (const s of stmt.body) {
                        ...
                        if (s.type === 'ContinueStatement')
                            break;
                        if (r !== null && s.type === 'ReturnStatement')
                            return r;
                    }
                }
                return null;
